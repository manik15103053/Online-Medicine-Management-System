...
Route::get('/disease', 'Frontend\PagesController@select_symptoms')->name('select.symptoms');
Route::post('/find_symptom', 'Frontend\PagesController@findSymptom')->name('findSymptom');
...
Route::group(['prefix' => 'admin'], function(){
  ...
  Route::group(['prefix' => '/symptoms'], function(){
      Route::get('/', 'Backend\symptomsController@showSymptoms')->name('showSymptoms');
      Route::post('/', 'Backend\symptomsController@createSymptoms')->name('createSymptoms');
      Route::get('/{id}', 'Backend\symptomsController@updateSymptoms')->name('updateSymptoms');
      Route::put('/{id}', 'Backend\symptomsController@updateSymptomsProcess')->name('updateSymptomsProcess');
      Route::delete('/{id}', 'Backend\symptomsController@deleteSymptoms')->name('deleteSymptoms');
  });
  // Diseases Routes
  Route::group(['prefix' => '/diseases'], function(){
      Route::get('/', 'Backend\diseasesController@showDiseases')->name('showDiseases');
      Route::post('/', 'Backend\diseasesController@createDiseases')->name('createDiseases');
      Route::get('/{id}', 'Backend\diseasesController@updateDiseases')->name('updateDiseases');
      Route::put('/{id}', 'Backend\diseasesController@updateDiseasesProcess')->name('updateDiseasesProcess');
  });
  // Diseases Routes
  Route::group(['prefix' => '/mapping'], function(){
      Route::get('/', 'Backend\mappingController@showMappingList')->name('showMappingList');
      Route::post('/', 'Backend\mappingController@createMapping')->name('createMapping');
      Route::get('/{id}', 'Backend\mappingController@updateMapping')->name('updateMapping');
      Route::put('/{id}', 'Backend\mappingController@updateMappingProcess')->name('updateMappingProcess');
  });
