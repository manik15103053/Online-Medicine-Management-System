...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    <li class="nav-item nav-profile">
      <div class="nav-link">
        <div class="profile-image"> Admin <span class="online-status online"></span> </div>
    ...
    <li class="nav-item"><a class="nav-link" href="{{route('showSymptoms')}}">
      <span class="menu-title">Symptoms</span></a>
    </li>

    <li class="nav-item"><a class="nav-link" href="{{route('showDiseases')}}">
      <span class="menu-title">Diseases</span></a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="{{route('showMappingList')}}">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#order-pages" aria-expanded="false" aria-controls="order-pages">
         <span class="menu-title">Manage Orders</span><i class="menu-arrow"></i></a>
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#division-pages" aria-expanded="false" aria-controls="general-pages">
         <span class="menu-title">
