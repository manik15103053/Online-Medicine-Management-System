        ...
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6 border-right" >
                ...
                <p><strong> Orderer Shiping Address: </strong>{{ $order->shipping_address}} </p>
          ...
          @else
            <input type="submit" name="" value="Paid Payment" class=" btn btn-success" >
          @endif
          </form>
        </div>
      </div>
